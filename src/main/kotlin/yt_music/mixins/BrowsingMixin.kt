...
interface BrowsingMixin {
     ...
     * </p>
     */
    fun getHome(limit: Int = 3): JsonArray
     ...
     * `get_artist_albums`.
     * @param channelId_ channel id of the artist
     ...
     * ```
     */
    fun getArtist(channelId_: String): JsonObject
     ...
     */
    fun getArtistAlbums(channelId: String, params: String): JsonArray
     ...
     *     ```
     */
    fun getUser(channelId: String): JsonObject
     ...
     */
    fun getUserPlaylists(channelId: String, params: String): JsonArray
     ...
     * @return: browseId (starting with `MPREb`)
     */
    fun getAlbumBrowseId(audioPlaylistId: String): String?

    /**
     * Get information and tracks of an album
     * @param browseId browseId of the album, for example
     * returned by [org.alphapacka.com.mixins.SearchMixin.search]
     ...
     *     ```
     */
    fun getAlbum(browseId: String): Album
     ...
     *     ```
     */
    fun getSong(videoId: String, signatureTimestamp_: Long? = null): JsonObject
     ...
     *     ```
     */
    fun getSongRelated(browseId: String): JsonArray
     ...
     *     ```
     */
    fun getLyrics(browseId: String): JsonObject

    /**
     * Extract the URL for the `base.js` script from YouTube Music.
     * @return URL to `base.js`
     * @throws [NoSuchElementException] when the url for the base.js script could not be identified.
     */
    @Throws(NoSuchElementException::class)
    fun getBaseJsUrl(): String
     ...
     * isn't specified a call will be made to [getBaseJsUrl].
     * @return `signatureTimestamp` string
     * @throws [NoSuchElementException] when the signature timestamp could not be identified
     */
    @Throws(NoSuchElementException::class)
    fun getSignatureTimestamp(url: String? = null): Int
     ...
     * @return JsonObject with artist and their selection & impression value
     * Example:
     * ```
     *     {
     *         "Drake": {
     ...
     *     ```
     */
    fun getTasteprofile(): JsonObject
     ...
     * @param tasteProfile tasteprofile result from [getTasteprofile].
     * Pass this if you call [getTasteprofile] anyway to save an extra request.
     * @return None if successful
     * @throws [NoSuchElementException] if an artist is not present in the taste profile
     */
    @Throws(NoSuchElementException::class)
    fun setTasteprofile(artists: Collection<String>, tasteProfile: JsonObject? = null)
